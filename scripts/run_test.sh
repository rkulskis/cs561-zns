...
for config_name in "${CONFIGS[@]}"; do
    ...
    for nj in 1 2 4 8 16; do
        ...
        sshpass -p femu scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -P 8080 "$FIO_FILE" femu@127.0.0.1:~/
        sshpass -p femu ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -p 8080 femu@127.0.0.1 \
